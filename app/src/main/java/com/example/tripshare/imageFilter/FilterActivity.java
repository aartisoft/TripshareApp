...
import com.example.tripshare.imageFilter.Adapter.ViewPagerAdapter;
...
import com.example.tripshare.imageFilter.Utils.BitmapUtils;
...
public class FilterActivity extends AppCompatActivity implements FiltersListFragmentListener, EditImageFragmentListener {
    ...
    private void loadImage() throws IOException {
       ...
       */
        originalBitmap = MediaStore.Images.Media.getBitmap(getContentResolver(),Uri.parse(uri));
    ...
    private void gotoseeedit() {

        try {
            String path = BitmapUtils.insertImage(getContentResolver(),
                    finalBitmap,
                    System.currentTimeMillis() + "_profile.jpg",
                    null);
            Log.d(TAG, "saved:before "+uri);
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            Toast.makeText(FilterActivity.this, "권한이 거부됐습니다.", Toast.LENGTH_SHORT).show();
                        }
                    }
